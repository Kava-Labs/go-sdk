...
func (r ResponseCheckTx) IsErr() bool {
	return r.Code != abci_types.CodeTypeOK
}
...
type ResponseCheckTx struct {
	...
	Events    []abci_types.Event `json:"events,omitempty"`
...
func (r *ResponseCheckTx) complement() {
	if len(r.Tags) > 0 {
		r.Events = []abci_types.Event{{Attributes: r.Tags}}
...
type ResponseEndBlock struct {
	ValidatorUpdates      []abci_types.ValidatorUpdate `json:"validator_updates"`
	ConsensusParamUpdates *abci_types.ConsensusParams  `json:"consensus_param_updates,omitempty"`
	Events                []abci_types.Event           `json:"events,omitempty"`
	Tags                  []cmn.KVPair                 `json:"tags,omitempty"`
}
