...
func main() {
	...
	// addr, err := sdk.AccAddressFromBech32(mnemonicAddr)
	// if err != nil {
	// 	panic(err)
	// }
	...
	msg := bep3.NewMsgCreateAtomicSwap(fromAddr, toAddr, recipientOtherChain, senderOtherChain,
		randomNumberHash, timestamp, amount, heightSpan)
